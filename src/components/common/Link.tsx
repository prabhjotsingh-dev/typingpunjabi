  ...
  "",
  {
    variants: {
      variant: {
        ...
        navLink:
          "animate-nav-item px-4 py-1.5 rounded-xl relative cubic-transition focus-visible:outline focus-visible:outline-2 focus-visible:outline-primary-dark/30",
        navLinkMobile:
    ...
    compoundVariants: [
      ...
      },
      {
        ...
        isActive: true,
        className: "font-bold bg-primary-dark/10 text-primary-dark",
      },
      {
        variant: "navLinkMobile",
        isActive: false,
  ...
  ({ className, variant, isActive, children, ...props }, ref) => {
    ...
    if (variant === "navLink") {
      return (
        ...
        >
          {isActive && (
            <span className="absolute inset-0 bg-glass-active rounded-xl border border-primary-light shadow-[inset_0_1px_0_rgba(255,255,255,0.3)]"></span>
          )}
          {!isActive && (
